#!/usr/bin/env python3
"""
Test script for simple SFT LoRA training
========================================

This script tests the simplified SFT LoRA training with minimal parameters
...
def main():
    print("🚀 Testing Simple SFT with LoRA training...")
    print("=" * 60)
    
    # Check if the script exists
    script_path = "sft-lora-simple.py"
    ...
    try:
        ...
        # Run the SFT LoRA script
        print("📁 Running simple SFT with LoRA training...")
